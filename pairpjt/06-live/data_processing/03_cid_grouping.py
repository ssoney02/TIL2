...
def cid_grouping(excel_file, json_file) :
    ...
    for index, row in df.iterrows():
        ...
        # get 메서드 사용 -> 카테고리 있는지 확인하고 없으면 추가
        # get(category, []) -> 없으면 기본값으로 비어있는 [] -> 여기에 append(cid) 해도 됨!
    ...
    with open(json_file, 'w', encoding='utf-8') as f:
        json.dump(final_groups, f, ensure_ascii=False, indent=4)        # 그냥 파이썬으로 쓸거니까 indent4로 함
